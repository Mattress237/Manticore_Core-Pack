class Manticore_Loadout_RHS_Heli_OH6M : RHS_MELB_H6M
{
	displayName = "OH-6M";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_Heli_MH6M : RHS_MELB_MH6M
{
	displayName = "MH-6M";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_Heli_AH6M : RHS_MELB_AH6M
{
	displayName = "AH-6M";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_Heli_CH47F : RHS_CH_47F
{
	displayName = "CH-47F";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_Heli_UH60M : RHS_UH60M
{
	displayName = "UH-60M";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_Heli_UH60M2 : RHS_UH60M2
{
...
class Manticore_Loadout_RHS_Heli_UH60M_EWS : RHS_UH60M_ESSS2
{
...
class Manticore_Loadout_RHS_Heli_UH60M_ESSS : RHS_UH60M_ESSS
{
...
class Manticore_Loadout_RHS_Heli_UH60M_MEV : RHS_UH60M_MEV2
{
...
class Manticore_Loadout_RHS_Heli_UH60M_ESSS_MEV : RHS_UH60M_MEV
{
...
class Manticore_Loadout_RHS_Heli_AH64D : RHS_AH64D
{
	displayName = "AH-64D";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_Heli_CH53E : rhsusf_CH53E_USMC
{
	displayName = "CH-53E";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_Heli_UH1Y : RHS_UH1Y
{
	displayName = "UH-1Y";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_Heli_UH1Y_FFAR : RHS_UH1Y_FFAR
{
...
class Manticore_Loadout_RHS_Heli_UH1Y_Unarmed : RHS_UH1Y_UNARMED
{
...
class Manticore_Loadout_RHS_Heli_AH1Z : RHS_AH1Z
{
	displayName = "AH-1Z";
	scope = 2;
	side = 1;
