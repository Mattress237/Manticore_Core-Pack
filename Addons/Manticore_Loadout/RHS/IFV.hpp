class Manticore_Loadout_RHS_IFV_M2A3 : RHS_M2A3
{
	displayName = "M2A3";
	scope = 2;
	side = 1;
...
class Manticore_Loadout_RHS_IFV_M2A3_BUSKI : RHS_M2A3_BUSKI
{
...
class Manticore_Loadout_RHS_IFV_M2A3_BUSKIII : RHS_M2A3_BUSKIII
{
...
class Manticore_Loadout_RHS_IFV_M6A2 : RHS_M6
{
	displayName = "M6A2 (AA)";
	scope = 2;
	side = 1;
